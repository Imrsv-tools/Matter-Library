> **ARCHIVED 2026-09-23 (Phase01 step 1.5).** The pre-standalone README, kept verbatim for its design intent. Its successor is the repo-root `Readme.md` (identity only); the design itself now lives in `docs/specs/`, and the plan in `docs/Planning/Roadmap.md`.
